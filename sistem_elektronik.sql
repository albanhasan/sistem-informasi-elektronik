...
ALTER TABLE public.electronics OWNER TO postgres;
...
ALTER TABLE public.electronics_id_seq OWNER TO postgres;

--
-- Name: electronics_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: electronics id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
COPY public.category (id, name, deleted_at, created_at, updated_at) FROM stdin;
1	Handphone	\N	2022-07-04 14:59:26	2022-07-04 14:59:26
2	Laptop	\N	2022-07-04 14:59:42	2022-07-04 14:59:42
\.
...
COPY public.electronics (id, name, slug, category_id, description, price, stock, image_name, deleted_at, created_at, updated_at) FROM stdin;
1	Acer Swift X  2021	acer-swift-x-2021	2	OK	2500	10	202207041621BMW-M3-GTR-2001-10.webp	\N	2022-07-04 15:32:06	2022-07-04 16:22:10
2	Iphone X	iphone-x	1	mobil	900000	3	202207041625DSC_0113.JPG	2022-07-04 16:25:25	2022-07-04 16:25:22	2022-07-04 16:25:25
\.
...
5	2022_03_29_125035_create_products_table	1
6	2022_06_14_123556_create_transactions_table	1
7	2022_06_14_123702_create_transactions_details_table	1
8	2022_07_02_183754_create_electronics_table	1
9	2022_07_02_185801_category	1
\.
...
COPY public.products (id, name, slug, type, description, price, quantity, deleted_at, created_at, updated_at) FROM stdin;
\.
...
COPY public.transaction_details (id, transaction_id, product_id, deleted_at, created_at, updated_at) FROM stdin;
\.
...
COPY public.transactions (id, uuid, name, email, number, address, transaction_total, transaction_status, deleted_at, created_at, updated_at) FROM stdin;
\.
...
COPY public.users (id, name, email, "isAdmin", email_verified_at, password, remember_token, created_at, updated_at) FROM stdin;
4	albanhasan	albanhasan40@gmail.com	t	\N	$2y$10$0Kkodgy9Lt.h4vpW1NVq4eL1Mo7p9ERkQb.BBedbRSNAjCiCEwoMu	\N	2022-07-04 22:28:15	2022-07-04 22:28:15
\.
...
SELECT pg_catalog.setval('public.electronics_id_seq', 2, true);
